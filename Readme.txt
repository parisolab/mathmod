...
1) Add user defined variables to reduce processing time ("Arena_02" script, for instance ,is more than 3 times faster to render than the original "Arena" script)
