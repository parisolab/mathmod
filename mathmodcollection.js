{
	...
	},
	{
		...
		"Iso3D": {
			...
			"EarthPlanet",
			"MoonPlanet"],
			"Fxyz": ["((x-4*sin(t*pi/3))*(x-4*sin(t*pi/3)) + (y-2*cos(t*pi/3))*(y-2*cos(t*pi/3)) + z*z - .6)*min( (x-4*sin(t*pi/3))*(x-4*sin(t*pi/3)) + (y-2*cos(t*pi/3))*(y-2*cos(t*pi/3))  + z*z - .6, z) +0.2",
	...
	},
	{
		...
		"Iso3D": {
			...
			"Fxyz": ["(Ax + By+ z*z - .6)*min( Ax + By  + z*z - .6, z) +0.2",
			"Ax+ By + (z-.2)*(z-.2) - .6 ",
			"Cx + Dy  + (z-.2)*(z-.2) - .1"],
			"Xmin": ["-5",
			"-1+4*sin(t*pi/10)",
	...
	},
	{
		...
		"Iso3D": {
			...
			"20",
			"20"],
			"Fxyz": ["(1.5*(Hx-Gy)^2 + (Gx+ Hy)^2 +(z+.8)^2 -(abs(2.2*sin(t*pi/10))))*(Ax + By+ Fz)*min( (1.5*(Hx-Gy)^2 + (Gx+ Hy)^2 +(z+.8)^2 -(abs(2.2*sin(t*pi/10))))*(Ax + By + Fz), z) +1.",
			"Ax+ By + Ez",
			"Cx + Dy  + Ez + .5",
	...
	},
	{
		"Iso3D": {
			...
			"Cnd": ["(x^2+y^2+z^2)>9"],
			"Fxyz": ["(2*x^7-42*x^5*y^2+70*x^3*y^4-14*x*y^6-14*x^6+70*x^4*y^2+70*x^2*y^4-14*y^6+28*x^5+56*x^3*y^2+28*x*y^4-84*x^2*y^2+28*y^4-42*x^3-42*x*y^2+14*x^2-14*y^2+14*x) + 0.5* (64*z^7-112*z^5+56*z^3-7*z+5)"],
			"Xmax": ["3"],
			"Xmin": ["-3"],
			"Ymax": ["3"],
			"Ymin": ["-3"],
	...
	},
	{
		"Iso3D": {
			...
			"Varu": ["A=cos(0.9589716*u)",
			"B=sin(0.9589716*u)"],
			"Fxyz": ["-49.95*((x/2.34)^4+(y*Ax - z*Bx)^4+ (y*Bx + z*Ax)^4) +(-99.95)* ((x/2.34)^2 * (y*Ax - z*Bx)^2+(x/2.34)^2 * (y*Bx + z*Ax)^2+(y*Ax - z*Bx)^2 * (y*Bx + z*Ax)^2)+(141.12* (x/2.34-1))*((x/2.34)^2 +(y*Ax - z*Bx)^2+(y*Bx + z*Ax)^2)+(54.7 *x)* (-4 +0.8547 * x) + 262.4 * (y*Ax - z*Bx)^2 + 256"],
			"Xmax": [" 2.5*3.9*0.6"],
			"Xmin": ["-2*3.9*0.6"],
			"Ymax": [" 2"],
			"Ymin": ["-2"],
	...
	},
	{
		...
		l : Real number (-3,1) --> Thickness"],
			...
			"Fxyz": ["(x^16 + y ^16 + z^16 ) -(cos(7*x) +cos(7*y) +cos(7*z)) -.1"],
			"Xmin": ["-1.1"],
			"Xmax": [" 1.1"],
			"Ymin": ["-1.1"],
			"Ymax": [" 1.1"],
	...
	{
		"Iso3D": {
			"Description": [" Another closed isosurface but in this case we consider the outside volume delimited by the Schwarz surface.The \"outside\" volume is defined by deleting the signe \"-\""],
			"Name":["CloseIso_1"],
		...
		}},
{
	"Iso3D": {
		...
		"Fxyz": ["if((x^10+y^10+z^10<3*(3.5^10)),(cos(x)+cos(y)+cos(z))*((cos(x+sin(x)/(2*sqrt(sin(x)^2+sin(y)^2+sin(z)^2)))+cos(y+sin(y)/(2*sqrt(sin(x)^2+sin(y)^2+sin(z)^2)))+cos(z+sin(z)/(2*sqrt(sin(x)^2+sin(y)^2+sin(z)^2))))),(x^10+y^10+z^10-3*(3.5^10)))"],
		"Xmin": ["-4"],
		"Xmax": ["4"],
		"Ymin": ["-4"],
		"Ymax": ["4"],
...
},
{
	"Param3D": {
		"Name": ["Shell"],
		"Cnd": ["(x^2+y^2)>2.0"],
        "Varu": ["A=(u-4*sin(pi/10))^2",
        "B=(u-2*cos(pi/10))^2",
        "C=(u-2*sin(pi)-4*sin(pi/10))^2",
        "D=(u-2*cos(pi)-2*cos(pi/10))^2"],
...
},
{
	...
	},
	{
		"Iso3D": {
			...
			"isoTransform=if(x*x<10.24,SchwarzP(x,y,z,t),1)+.1*M*exp(x*x-9)",
	...
	},
	{
		"Param3D": {
            ...
            "W2 = 27*pi/180",
			"N = 8"],
            "Funct": ["Re=(1/sqrt((cos(u)/a)^2 + (sin(u)/b)^2) + if(W1=0|W2=0|N=0,0, L*exp(-(2*(u-P)/W1)^2-(2*(2*pi*(N*v/(2*pi) -floor(N*v/(2*pi))))/W2)^2)) )"],
