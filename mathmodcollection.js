  ...
  "MathModels": [
    {
        "Param3D": {
            ...
            "Funct": ["Rfctv=(v-vmax)/(vmin-vmax)","Rfctu=if(u<0,-(umax+(u))/(umax-Teta/Noid),(umax-(u))/(umax-Teta/Noid))","f1x=(R*Rfctv(u,v,t)^k+r*cosh(v/2))*cos(u)-R*Rfctv(u,v,t)^k","f2x=(R*Rfctv(u,v,t)^k+r*cosh(v/2))*cos(Teta/Noid)*(pi-abs(u))/(pi-Teta/Noid)-R*Rfctv(u,v,t)^k","f1y=(R*Rfctv(u,v,t)^k+r*cosh(v/2))*sin(u)","f2y=(R*Rfctv(Teta/Noid,v,t)^k+r*cosh(v/2))*sin(Teta/Noid)*Rfctu(u,v,t)","F1x=-if(abs(u)<(Teta/Noid),f1x(u,v,t),f1x(u,v,t)*(v-vmin)/(vmax-vmin)-f2x(u,v,t)*(v-vmax)/(vmax-vmin))-R","F1y=if(abs(u)<(Teta/Noid),f1y(u,v,t),f1y(u,v,t)*(v-vmin)/(vmax-vmin)-f2y(u,v,t)*(v-vmax)/(vmax-vmin))","F1z=v","Rotx= F1x(u,v,t) -2*(sin(t*Teta/Noid)*F1x(u,v,t)+cos(t*Teta/Noid)*F1y(u,v,t))*sin(t*Teta/Noid)",],
            "Fx": ["F1x(u,v,t)","Rotx(u,v,(1))","F1x(u,v,t)-2*(sin(2*Teta/Noid)*F1x(u,v,t)+cos(2*Teta/Noid)*F1y(u,v,t))*sin(2*Teta/Noid)","F1x(u,v,t)-2*(sin(3*Teta/Noid)*F1x(u,v,t)+cos(3*Teta/Noid)*F1y(u,v,t))*sin(3*Teta/Noid)","F1x(u,v,t)-2*(sin(4*Teta/Noid)*F1x(u,v,t)+cos(4*Teta/Noid)*F1y(u,v,t))*sin(4*Teta/Noid)","F1x(u,v,t)-2*(sin(5*Teta/Noid)*F1x(u,v,t)+cos(5*Teta/Noid)*F1y(u,v,t))*sin(5*Teta/Noid)","F1x(u,v,t)-2*(sin(6*Teta/Noid)*F1x(u,v,t)+cos(6*Teta/Noid)*F1y(u,v,t))*sin(6*Teta/Noid)","F1x(u,v,t)-2*(sin(7*Teta/Noid)*F1x(u,v,t)+cos(7*Teta/Noid)*F1y(u,v,t))*sin(7*Teta/Noid)","F1x(u,v,t)-2*(sin(8*Teta/Noid)*F1x(u,v,t)+cos(8*Teta/Noid)*F1y(u,v,t))*sin(8*Teta/Noid)","F1x(u,v,t)-2*(sin(9*Teta/Noid)*F1x(u,v,t)+cos(9*Teta/Noid)*F1y(u,v,t))*sin(9*Teta/Noid)","F1x(u,v,t)-2*(sin(10*Teta/Noid)*F1x(u,v,t)+cos(10*Teta/Noid)*F1y(u,v,t))*sin(10*Teta/Noid)","F1x(u,v,t)-2*(sin(11*Teta/Noid)*F1x(u,v,t)+cos(11*Teta/Noid)*F1y(u,v,t))*sin(11*Teta/Noid)"],
            "Fy": ["F1y(u,v,t)","F1y(u,v,t)-2*(sin(Teta/Noid)* F1x(u,v,t) +cos(Teta/Noid)*F1y(u,v,t))*cos(Teta/Noid)","F1y(u,v,t)-2*(sin(2*Teta/Noid)* F1x(u,v,t) +cos(2*Teta/Noid)*F1y(u,v,t))*cos(2*Teta/Noid)","F1y(u,v,t)-2*(sin(3*Teta/Noid)* F1x(u,v,t) +cos(3*Teta/Noid)*F1y(u,v,t))*cos(3*Teta/Noid)","F1y(u,v,t)-2*(sin(4*Teta/Noid)* F1x(u,v,t) +cos(4*Teta/Noid)*F1y(u,v,t))*cos(4*Teta/Noid)","F1y(u,v,t)-2*(sin(5*Teta/Noid)* F1x(u,v,t) +cos(5*Teta/Noid)*F1y(u,v,t))*cos(5*Teta/Noid)","F1y(u,v,t)-2*(sin(6*Teta/Noid)*F1x(u,v,t)+cos(6*Teta/Noid)*F1y(u,v,t))*cos(6*Teta/Noid)","F1y(u,v,t)-2*(sin(7*Teta/Noid)*F1x(u,v,t)+cos(7*Teta/Noid)*F1y(u,v,t))*cos(7*Teta/Noid)","F1y(u,v,t)-2*(sin(8*Teta/Noid)*F1x(u,v,t)+cos(8*Teta/Noid)*F1y(u,v,t))*cos(8*Teta/Noid)","F1y(u,v,t)-2*(sin(9*Teta/Noid)*F1x(u,v,t)+cos(9*Teta/Noid)*F1y(u,v,t))*cos(9*Teta/Noid)","F1y(u,v,t)-2*(sin(10*Teta/Noid)*F1x(u,v,t)+cos(10*Teta/Noid)*F1y(u,v,t))*cos(10*Teta/Noid)","F1y(u,v,t)-2*(sin(11*Teta/Noid)*F1x(u,v,t)+cos(11*Teta/Noid)*F1y(u,v,t))*cos(11*Teta/Noid)"],
    ...
    },
    {
        "Iso3D": {
            ...
            "Name": ["SCosta"],
            "Component": ["SCosta"],
            "Const": ["N=6","c=1/10000","th=2/10","Xval=15","Yval=20","Zval=20"],
    ...
    },
    {
      "Iso3D": {
        ...
        "Grid": ["120","120","120","120","120","120","120","120"]
      },
      "Texture": {
    ...
    {
        "Iso3D": {
            "Description ": ["Hexagrams Menger Sponge Level 4 by Abderrahman Taha 30/10/2022"],
            "Name": ["Hexagrams_Menger_Level4"],
            "Cnd": ["(x+y+z)> 0"],
            "Const": ["a=1/81", "b=1/27", "c=1/9", "d=2/3", "e=8/9", "f=2/9", "g=4/9", "h=1/3", "L=1001/1000"],
            "Component": ["MengerSponge"],
            "Funct": ["Ax = ((abs(x-d) <a)+ (abs(x-20/27) <a)+ (abs(x-16/27) <a)+(abs(x-e) <a) + (abs(x-26/27) <a) + (abs(x-22/27) <a) +(abs(x-g) <a) +(abs(x-14/27) <a) +(abs(x-10/27) <a) +(abs(x+d) <a) +(abs(x+16/27) <a) +(abs(x+20/27) <a) +(abs(x+g) <a) +(abs(x+10/27) <a) +(abs(x+14/27) <a) +(abs(x+e) <a) +(abs(x+22/27) <a) +(abs(x+26/27) <a) +(abs(x) <a) + (abs(x-2/27) <a) +(abs(x+2/27) <a) +(abs(x-f) <a) + (abs(x-8/27) <a) + (abs(x-4/27) <a) +(abs(x+f) <a)+(abs(x+4/27) <a)+(abs(x+8/27) <a))",
                "Ay = ((abs(y-d) <a)+ (abs(y-20/27) <a)+ (abs(y-16/27) <a)+(abs(y-e) <a) + (abs(y-26/27) <a) + (abs(y-22/27) <a) +(abs(y-g) <a) +(abs(y-14/27) <a) +(abs(y-10/27) <a) +(abs(y+d) <a) +(abs(y+16/27) <a) +(abs(y+20/27) <a) +(abs(y+g) <a) +(abs(y+10/27) <a) +(abs(y+14/27) <a) +(abs(y+e) <a) +(abs(y+22/27) <a) +(abs(y+26/27) <a) +(abs(y) <a) + (abs(y-2/27) <a) +(abs(y+2/27) <a) +(abs(y-f) <a) + (abs(y-8/27) <a) + (abs(y-4/27) <a) +(abs(y+f) <a)+(abs(y+4/27) <a)+(abs(y+8/27) <a))",
                "Az = ((abs(z-d) <a)+ (abs(z-20/27) <a)+ (abs(z-16/27) <a)+(abs(z-e) <a) + (abs(z-26/27) <a) + (abs(z-22/27) <a) +(abs(z-g) <a) +(abs(z-14/27) <a) +(abs(z-10/27) <a) +(abs(z+d) <a) +(abs(z+16/27) <a) +(abs(z+20/27) <a) +(abs(z+g) <a) +(abs(z+10/27) <a) +(abs(z+14/27) <a) +(abs(z+e) <a) +(abs(z+22/27) <a) +(abs(z+26/27) <a) +(abs(z) <a) + (abs(z-2/27) <a) +(abs(z+2/27) <a) +(abs(z-f) <a) + (abs(z-8/27) <a) + (abs(z-4/27) <a) +(abs(z+f) <a)+(abs(z+4/27) <a)+(abs(z+8/27) <a))",
                "Bx = ((abs(x-d) <b)+(abs(x-e) <b) + (abs(x-g) <b) +(abs(x+d) <b) +(abs(x+g) <b) + (abs(x+e) <b) +(abs(x) <b) + (abs(x-f) <b) + (abs(x+f) <b))",
                "By = ((abs(y-d) <b)+(abs(y-e) <b) + (abs(y-g) <b) +(abs(y+d) <b) +(abs(y+g) <b) + (abs(y+e) <b) +(abs(y) <b) + (abs(y-f) <b) + (abs(y+f) <b))",
                "Bz = ((abs(z-d) <b)+(abs(z-e) <b) + (abs(z-g) <b) +(abs(z+d) <b) +(abs(z+g) <b) + (abs(z+e) <b) +(abs(z) <b) + (abs(z-f) <b) + (abs(z+f) <b))",
                "Cx = ((abs(x-d) <c) + (abs(x+d) <c) + (abs(x) <c))",
                "Cy = ((abs(y-d) <c) + (abs(y+d) <c) + (abs(y) <c))",
                "Cz = ((abs(z-d) <c) + (abs(z+d) <c) + (abs(z) <c))",
                "Dx = x^100",
                "Dy = y^100",
                "Dz = z^100"],
            "Fxyz": ["-(Dx(x,y,z,t) + Dy(x,y,z,t) + Dz(x,y,z,t) -1)*(((abs(x) >h | abs(y) > h)*(abs(z) >h | abs(y) > h)*(abs(x) >h | abs(z) > h))*( (Cx(x,y,z,t)*(Cy(x,y,z,t)+Cz(x,y,z,t)) + Cz(x,y,z,t)*Cy(x,y,z,t)) =0)*( (Bx(x,y,z,t)*(By(x,y,z,t)+Bz(x,y,z,t)) + Bz(x,y,z,t)*By(x,y,z,t)) =0)*( (Ax(x,y,z,t)*(Ay(x,y,z,t)+Az(x,y,z,t)) + Az(x,y,z,t)*Ay(x,y,z,t)) =0) ) "],
            "Xmax": [" L"],
            "Xmin": ["-L"],
            "Ymax": [" L"],
            "Ymin": ["-L"],
