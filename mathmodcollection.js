...
},
{
    ...
    },
    {
      "Iso3D": {
        ...
        "Fxyz": [
          " -(D(x,y,z,t) + D(y,z,x,t) + D(z,x,y,t) -1)*(((abs(x) >1/3 | abs(y) > 1/3)*(abs(z) >1/3 | abs(y) > 1/3)*(abs(x) >1/3 | abs(z) > 1/3))*( (C(x,y,z,t)*(C(y,z,x,t)+C(z,x,y,t)) + C(z,x,y,t)*C(y,z,x,t)) =0)*( (B(x,y,z,t)*(B(y,z,x,t)+B(z,x,y,t)) + B(z,x,y,t)*B(y,z,x,t)) =0)*( (A(x,y,z,t)*(A(y,z,x,t)+A(z,x,y,t)) + A(z,x,y,t)*A(y,z,x,t)) =0) ) "
        ],
        "Xmin": [
          "-1001/1000"
        ],
