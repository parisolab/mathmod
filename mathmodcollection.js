...

{
    "Iso3D": {
        ...
        "Funct": [
            ...
            "By=((abs(y-2/3)<1/27)+(abs(y-8/9)<1/27)+(abs(y-4/9)<1/27)+(abs(y+2/3)<1/27)+/Users/parisolab/Desktop/Photo+Nov+10,+2+34+25+PM.jpg(abs(y+4/9)<1/27)+(abs(y+8/9)<1/27)+(abs(y)<1/27)+(abs(y-2/9)<1/27)+(abs(y+2/9)<1/27))",
