...
,
    {
            "Param3D": {
                ...
                "Const": ["r1=5","H=r1/99","du=1/10000","dv=1/10000","u1max=pi","u1min=-pi","v1max=2*pi","v1min=0","M=114","N=16","umin=0","umax=2*pi","vmin=0","vmax=2*pi","Gu=(u1max-u1min)/N","Gv=(v1max-v1min)/M"
                ],
