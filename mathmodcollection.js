  ...
  "MathModels": [
    {
        "Param3D": {
            ...
            "Funct": ["Fx=u",
                    ...
                    "Fx3=Fx(u,vmin,t)+(T*R(n1(u,vmin,t),n2(u,vmin,t),n3(u,vmin,t)))*(v-vmin)/(vmax-vmin)",
                    "Fy3=Fy(u,vmin,t)+(T*R(n2(u,vmin,t),n3(u,vmin,t),n1(u,vmin,t)))*(v-vmin)/(vmax-vmin)",
                    "Fz3=Fz(u,vmin,t)+(T*R(n3(u,vmin,t),n1(u,vmin,t),n2(u,vmin,t)))*(v-vmin)/(vmax-vmin)",
                    "Fx4=Fx(u,vmax,t)+(T*R(n1(u,vmax,t),n2(u,vmax,t),n3(u,vmax,t)))*(v-vmin)/(vmax-vmin)",
                    "Fy4=Fy(u,vmax,t)+(T*R(n2(u,vmax,t),n3(u,vmax,t),n1(u,vmax,t)))*(v-vmin)/(vmax-vmin)",
                    "Fz4=Fz(u,vmax,t)+(T*R(n3(u,vmax,t),n1(u,vmax,t),n2(u,vmax,t)))*(v-vmin)/(vmax-vmin)",
                    "Fx5=Fx(umin,v,t)+(T*R(n1(umin,v,t),n2(umin,v,t),n3(umin,v,t)))*(u-umin)/(umax-umin)",
                    "Fy5=Fy(umin,v,t)+(T*R(n2(umin,v,t),n3(umin,v,t),n1(umin,v,t)))*(u-umin)/(umax-umin)",
                    "Fz5=Fz(umin,v,t)+(T*R(n3(umin,v,t),n1(umin,v,t),n2(umin,v,t)))*(u-umin)/(umax-umin)",
                    "Fx6=Fx(umax,v,t)+(T*R(n1(umax,v,t),n2(umax,v,t),n3(umax,v,t)))*(u-umin)/(umax-umin)",
                    "Fy6=Fy(umax,v,t)+(T*R(n2(umax,v,t),n3(umax,v,t),n1(umax,v,t)))*(u-umin)/(umax-umin)",
                    "Fz6=Fz(umax,v,t)+(T*R(n3(umax,v,t),n1(umax,v,t),n2(umax,v,t)))*(u-umin)/(umax-umin)"],
