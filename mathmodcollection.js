  ...
  "MathModels": [
    {
        "Param3D": {
            ...
            "Funct": ["l=((2*pi)/n)*((n*u/(2*pi))-floor(n*u/(2*pi)))",
                ...
                "fx=d*(aa*sin(beta)*cos(u)+h(u,v,t)*(cos(v+phi)*cos(u+omega)-sin(mu)*sin(v+phi)*sin(u+omega)))*exp(u*cot(alpha))",
                "fy=(-aa*sin(beta)*sin(u)-h(u,v,t)*(cos(v+phi)*sin(u+omega)+sin(mu)*sin(v+phi)*cos(u+omega)))*exp(u*cot(alpha))",
                "fz=(-aa*cos(beta)+h(u,v,t)*sin(v+phi)*cos(mu))*exp(u*cot(alpha))"],
            "Fx": ["fx(u,v,t)"],
            "Fy": ["fy(u,v,t)"],
            "Fz": ["fz(u,v,t)"],
            "Umax": ["4*pi"],
