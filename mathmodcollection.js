{
  "MathModels": [
    ...
    },
    {
        ...
        "Texture": {
            "Colors": ["R=if(((i%int(400/(2*(k-1))))<2 | ((j%80)<6)) , (7/10),abs(sin(v/8))/(16/10))","G=if(((i%int(400/(2*(k-1))))<2 | ((j%80)<6)) , (7/10) , abs(cos(v/8))/(16/10))","B=if(((i%int(400/(2*(k-1))))<2 | ((j%80)<6)) , (7/10),abs(cos(v/8)+sin(v/2))/2)","T=1"],
            "Name": "Rainbow",
            "Noise": ""
        }
    },
