  ...
  "MathModels": [
    ...
    },
    {
      "Iso3D": {
        ...
        "Fxyz": [
          "-max(-Cube(x,y,z,t), Octahedron((x%(1/N))-1/(2*N),(y%(1/N))-1/(2*N),(z%(1/N))-1/(2*N),t))"
        ],
        "Xmax": [
          "1"
        ],
    ...
    },
    {
      "Param3D": {
        "Description ": [
          "Wireframe (p,q) Knots by Abderrahman Taha 06/02/2018"
        ],
        "Const": [
          "r1=4",
          "H=r1/99",
        ...
        "Funct": [
          ...
          "n2=(DFzu(u,v,t)*DFxv(u,v,t)-DFxu(u,v,t)*DFzv(u,v,t))",
          "n3=(DFxu(u,v,t)*DFyv(u,v,t)-DFyu(u,v,t)*DFxv(u,v,t))",
          "Thickness1=H*sin(M*pi*(v-v1min)/(v1max-v1min)+((N*(u-u1min)/(u1max-u1min)))*(pi)+pi/2)",
          "Thickness2=H*sin(N*pi*(u-u1min)/(u1max-u1min)+((M*(v-v1min)/(v1max-v1min)))*(pi)-pi/2)",
          "Tx=Fx(u,v,t)+Thickness1(u,v,t)*Rapp(n1(u,v,t),n2(u,v,t),n3(u,v,t))",
          "Ty=Fy(u,v,t)+Thickness1(u,v,t)*Rapp(n2(u,v,t),n3(u,v,t),n1(u,v,t))",
          "Tz=Fz(u,v,t)+Thickness1(u,v,t)*Rapp(n3(u,v,t),n1(u,v,t),n2(u,v,t))",
          "Sx=Fx(u,v,t)+Thickness2(u,v,t)*Rapp(n1(u,v,t),n2(u,v,t),n3(u,v,t))",
          "Sy=Fy(u,v,t)+Thickness2(u,v,t)*Rapp(n2(u,v,t),n3(u,v,t),n1(u,v,t))",
          "Sz=Fz(u,v,t)+Thickness2(u,v,t)*Rapp(n3(u,v,t),n1(u,v,t),n2(u,v,t))",
          "DFxu=((Fx(u+du,v,t)-Fx(u,v,t))/du)",
          "DFxv=((Fx(u,v+dv,t)-Fx(u,v,t))/dv)",
          "DFyu=((Fy(u+du,v,t)-Fy(u,v,t))/du)",
          "DFyv=((Fy(u,v+dv,t)-Fy(u,v,t))/dv)",
          ...
          "n2=(DFzu(u,v,t)*DFxv(u,v,t)-DFxu(u,v,t)*DFzv(u,v,t))",
          "n3=(DFxu(u,v,t)*DFyv(u,v,t)-DFyu(u,v,t)*DFxv(u,v,t))",
          "F2x=Tx(u1min + CmpId(0)*Gu,v,t)",
          "F2y=Ty(u1min + CmpId(0)*Gu,v,t)",
          "F2z=Tz(u1min + CmpId(0)*Gu,v,t)",
          "DF2xv=DFxv(u1min + CmpId(0)*Gu,v,t)",
          "DF2yv=DFyv(u1min + CmpId(0)*Gu,v,t)",
          "DF2zv=DFzv(u1min + CmpId(0)*Gu,v,t)",
          "DF2xv2=n1(u1min + CmpId(0)*Gu,v,t)",
          ...
          "Nyv=Rapp(DF2yv2(u,v,t),DF2xv2(u,v,t),DF2zv2(u,v,t))",
          "Nzv=Rapp(DF2zv2(u,v,t),DF2yv2(u,v,t),DF2xv2(u,v,t))",
          "Binxv=(DF2yv(u,v,t)*Nzv(u,v,t)-DF2zv(u,v,t)*Nyv(u,v,t))*Bx(DF2xv(u,v,t),DF2yv(u,v,t),DF2zv(u,v,t))",
          "Binyv=(DF2zv(u,v,t)*Nxv(u,v,t)-DF2xv(u,v,t)*Nzv(u,v,t))*Bx(DF2xv(u,v,t),DF2yv(u,v,t),DF2zv(u,v,t))",
          "Binzv=(DF2xv(u,v,t)*Nyv(u,v,t)-DF2yv(u,v,t)*Nxv(u,v,t))*Bx(DF2xv(u,v,t),DF2yv(u,v,t),DF2zv(u,v,t))",
          "Tx=F2x(u,v,t)+(r1/100)*(Nxv(u,v,t)*cos(u)+Binxv(u,v,t)*sin(u))",
          "Ty=F2y(u,v,t)+(r1/100)*(Nyv(u,v,t)*cos(u)+Binyv(u,v,t)*sin(u))",
          "Tz=F2z(u,v,t)+(r1/100)*(Nzv(u,v,t)*cos(u)+Binzv(u,v,t)*sin(u))",
          "F2x=Sx(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "F2y=Sy(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "F2z=Sz(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "DF2xu=DFxu(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "DF2yu=DFyu(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "DF2zu=DFzu(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          "DF2xu2=n1(u,v1min + (CmpId(0)-(N+1))*Gv,t)",
          ...
          "Nyu=Rapp(DF2yu2(u,v,t),DF2xu2(u,v,t),DF2zu2(u,v,t))",
          "Nzu=Rapp(DF2zu2(u,v,t),DF2yu2(u,v,t),DF2xu2(u,v,t))",
          "Binxu=(DF2yu(u,v,t)*Nzu(u,v,t)-DF2zu(u,v,t)*Nyu(u,v,t))*Bx(DF2xu(u,v,t),DF2yu(u,v,t),DF2zu(u,v,t))",
          "Binyu=(DF2zu(u,v,t)*Nxu(u,v,t)-DF2xu(u,v,t)*Nzu(u,v,t))*Bx(DF2xu(u,v,t),DF2yu(u,v,t),DF2zu(u,v,t))",
          "Binzu=(DF2xu(u,v,t)*Nyu(u,v,t)-DF2yu(u,v,t)*Nxu(u,v,t))*Bx(DF2xu(u,v,t),DF2yu(u,v,t),DF2zu(u,v,t))",
          "Sx=F2x(u,v,t)+(r1/100)*(Nxu(u,v,t)*cos(v)+Binxu(u,v,t)*sin(v))",
          "Sy=F2y(u,v,t)+(r1/100)*(Nyu(u,v,t)*cos(v)+Binyu(u,v,t)*sin(v))",
          "Sz=F2z(u,v,t)+(r1/100)*(Nzu(u,v,t)*cos(v)+Binzu(u,v,t)*sin(v))"
        ],
        "Component": [
          "PlainWeaving_00",
          "PlainWeaving_01",
    ...
    },
    {
      "Param3D": {
        ...
        "Funct": [
          ...
          "n2=(DFzu(u,v,t)*DFxv(u,v,t)-DFxu(u,v,t)*DFzv(u,v,t))",
          "n3=(DFxu(u,v,t)*DFyv(u,v,t)-DFyu(u,v,t)*DFxv(u,v,t))",
          "n1=n1(u1min + (CmpId(0)%M)*Gu ,v1min + ( int(CmpId(0)/N -5/10) )*Gv,t)",
          "n2=n2(u1min + (CmpId(0)%M)*Gu ,v1min + ( int(CmpId(0)/N -5/10) )*Gv,t)",
          "n3=n3(u1min + (CmpId(0)%M)*Gu ,v1min + ( int(CmpId(0)/N -5/10) )*Gv,t)",
          ...
          "Sy= S2y(u,v,t) ",
          "Sz= S2z(u,v,t) ",
          "n01=if((int(CmpId(0)/M -5/10)%2) = 0 ,DFxv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2 ,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t), -DFxv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t))",
          "n02=if((int(CmpId(0)/M -5/10)%2) = 0 ,DFyv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t), -DFyv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t))",
          "n03=if((int(CmpId(0)/M -5/10)%2) = 0 ,DFzv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t), -DFzv(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t))",
          "n1=Rapp(n01(u,v,t),n02(u,v,t),n03(u,v,t))",
          "n2=Rapp(n02(u,v,t),n03(u,v,t),n01(u,v,t))",
          "n3=Rapp(n03(u,v,t),n01(u,v,t),n02(u,v,t))",
          "u1=(n2(u,v,t)*Nz(u,v,t)-n3(u,v,t)*Ny(u,v,t))",
          ...
          "S2y=(U1(u,v,t)*U2(u,v,t)*(1-c(u,v,t))+U3(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)^2*(1-c(u,v,t))+c(u,v,t)) * S0y(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U1(u,v,t)*s(u,v,t))* S0z(u,v,t) ",
          "S2z=(U1(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U2(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+U1(u,v,t)*s(u,v,t))* S0y(u,v,t) + (U3(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+c(u,v,t))* S0z(u,v,t)",
          "Sx= S2x(u,v,t) + Fx(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv , t)",
          "Sy= S2y(u,v,t) + Fy(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t) ",
          "Sz= S2z(u,v,t) + Fz(u1min + (CmpId(0)%M)*Gu + (int(CmpId(0)/M -5/10)%2)*Gu/2,v1min + ( int(CmpId(0)/N -5/10) )*Gv ,t)"
        ],
        "Component": [
          "Wireframe_Shell_00",
          "Wireframe_Shell_01",
    ...
    },
    {
      "Param3D": {
        ...
        "Funct": [
          ...
          "n2=(DFzu(u,v,t)*DFxv(u,v,t)-DFxu(u,v,t)*DFzv(u,v,t))",
          "n3=(DFxu(u,v,t)*DFyv(u,v,t)-DFyu(u,v,t)*DFxv(u,v,t))",
          "n1=n1(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t)",
          "n2=n2(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t)",
          "n3=n3(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t)",
          ...
          "S2y=(U1(u,v,t)*U2(u,v,t)*(1-c(u,v,t))+U3(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)^2*(1-c(u,v,t))+c(u,v,t)) * S0y(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U1(u,v,t)*s(u,v,t))* S0z(u,v,t) ",
          "S2z=(U1(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U2(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+U1(u,v,t)*s(u,v,t))* S0y(u,v,t) + (U3(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+c(u,v,t))* S0z(u,v,t)",
          "Tx=if((int(CmpId(0)/M -(5/10))%2) = 0, S2x(u,v,t)*cos(CmpId(0)*beta) - S2z(u,v,t)*sin(CmpId(0)*beta) , S2x(u,v,t) ) ",
          "Ty=if((int(CmpId(0)/M -(5/10))%2) = 0, S2y(u,v,t) , S2y(u,v,t)*cos(beta2) - S2z(u,v,t)*sin(beta2) ) ",
          "Tz=if((int(CmpId(0)/M -(5/10))%2) = 0, S2x(u,v,t)*sin(CmpId(0)*beta) +S2z(u,v,t)*cos(CmpId(0)*beta) , S2y(u,v,t)*sin(beta2) + S2z(u,v,t)*cos(beta2))",
          "Sx= S2x(u,v,t) ",
          "Sy= S2y(u,v,t) ",
          "Sz= S2z(u,v,t) ",
          "n01=if((((int(CmpId(0)/M -(5/10))%2) = 0) & (CmpId(0)%2)=1 ) , 1,0)",
          "n02=if(((int(CmpId(0)/M -(5/10))%2) = 1 ), 1,0)",
          "n03=if((((int(CmpId(0)/M -(5/10))%2) = 0) & (CmpId(0)%2)=0 ) , 1,0)",
          "n1=Rapp(n01(u,v,t),n02(u,v,t),n03(u,v,t))",
          "n2=Rapp(n02(u,v,t),n03(u,v,t),n01(u,v,t))",
          "n3=Rapp(n03(u,v,t),n01(u,v,t),n02(u,v,t))",
          "u1=(n2(u,v,t)*Nz(u,v,t)-n3(u,v,t)*Ny(u,v,t))",
          ...
          "U2=Rapp(u2(u,v,t),u3(u,v,t),u1(u,v,t))",
          "U3=Rapp(u3(u,v,t),u1(u,v,t),u2(u,v,t))",
          "c=if((((int(CmpId(0)/M -(5/10))%2) = 0) & (CmpId(0)%2)=0 ) ,1,0)",
          "s=if((((int(CmpId(0)/M -(5/10))%2) = 0) & (CmpId(0)%2)=0 ) ,0,1)",
          "S0x=Sx(u,v,t) ",
          "S0y=Sy(u,v,t) ",
          "S0z=Sz(u,v,t) ",
          "S2x=(U1(u,v,t)^2*(1-c(u,v,t))+c(u,v,t)) * S0x(u,v,t) + (U1(u,v,t)*U2(u,v,t)*(1-c(u,v,t))-U3(u,v,t)*s(u,v,t))* S0y(u,v,t) + (U1(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+U2(u,v,t)*s(u,v,t))* S0z(u,v,t) ",
          "S2y=(U1(u,v,t)*U2(u,v,t)*(1-c(u,v,t))+U3(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)^2*(1-c(u,v,t))+c(u,v,t)) * S0y(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U1(u,v,t)*s(u,v,t))* S0z(u,v,t) ",
          "S2z=(U1(u,v,t)*U3(u,v,t)*(1-c(u,v,t))-U2(u,v,t)*s(u,v,t)) * S0x(u,v,t) + (U2(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+U1(u,v,t)*s(u,v,t))* S0y(u,v,t) + (U3(u,v,t)*U3(u,v,t)*(1-c(u,v,t))+c(u,v,t))* S0z(u,v,t)",
          "Sx= S2x(u,v,t) + Fx(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t)",
          "Sy= S2y(u,v,t) + Fy(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t) ",
          "Sz= S2z(u,v,t) + Fz(u1min + (CmpId(0)%M)*Gu + if((int(CmpId(0)/M -(5/10))%2) = 0, 0, -(CmpId(0) %2)*Gu +Gu),v1min + ( int(CmpId(0)/N -(5/10)) )*Gv,t)"
        ],
        "Component": [
          "Wireframe_Shell_00",
          "Wireframe_Shell_01",
