  ...
  "MathModels": [
    ...
    },
    {
        "Param3D": {
            ...
            "Grid": ["1000","200"],
            "Funct": [
                "l=((2*pi)/n)*((n*v/(2*pi))-floor(n*v/(2*pi)))",
                "k=if(w1=0|w2=0|n=0,0,ll*exp(-(2*(u-p)/w1)^2-(2*l(u,v,t)/w2)^2))",
                "h=(1/(sqrt((cos(u)/a)^2+(sin(u)/b)^2)))+k(u,v,t)",
                "fx=d*(aa*sin(beta)*cos(v)+h(u,v,t)*(cos(u+phi)*cos(v+omega)-sin(mu)*sin(u+phi)*sin(v+omega)))*exp(v*cot(alpha))",
                "fy=(-aa*sin(beta)*sin(v)-h(u,v,t)*(cos(u+phi)*sin(v+omega)+sin(mu)*sin(u+phi)*cos(v+omega)))*exp(v*cot(alpha))",
                "fz=(-aa*cos(beta)+h(u,v,t)*sin(u+phi)*cos(mu))*exp(v*cot(alpha))"],
            "Fx": ["fx(v,u,t)"],
            "Fy": ["fy(v,u,t)"],
            "Fz": ["fz(v,u,t)"],
            "Umax": ["8*pi"],
