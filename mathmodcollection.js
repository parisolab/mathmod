...
},
{
    ...
    },
    {
      "Iso3D": {
        ...
        "Grid": ["20",
          ...
          "20",
          "20"],
        "Fxyz": ["((3/2)*(H(x,y,z,t)-G(y,x,z,t))^2 + (G(x,y,z,t)+ H(y,x,z,t))^2 +(z+4/5)^2 -(abs((11/5)*sin(t*M))))*(A(x,y,z,t) + B(y,x,z,t)+ F(z,y,x,t))*min( ((3/2)*(H(x,y,z,t)-G(y,x,z,t))^2 + (G(x,y,z,t)+ H(y,x,z,t))^2 +(z+4/5)^2 -(abs((11/5)*sin(t*M))))*(A(x,y,z,t) + B(y,x,z,t) + F(z,y,x,t)), z) +1",
    ...
    },
    {
      "Iso3D": {
        ...
        "Funct": ["Torus=((sqrt(x*x+y*y)-3)^2+z*z-1)",
          "P=(a*x+b*y+c*z+d)"],
        "Fxyz": ["Torus(x,y,(z+1),t)*Torus(x-2*P(x,y,z,t)*a/R,y-2*P(x,y,z,t)*b/R,z+1-2*P(x,y,z,t)*c/R,t)",
          "y+4-z"],
        "Xmax": ["4","4"],
        "Xmin": ["-4","-4"],
        "Ymax": ["8","8"],
    ...
    },
    {
      "Iso3D": {
        ...
        "Component": ["Drope",
          "Torus"],
        "Fxyz": ["z-(15/10)*x*sin(2*t)*exp(-x*x-y*y)-2*y*cos(3*t)*exp(-x*x-y*y)",
...
"SkekatalMenger= if(isoCondition(x,y,z,t)<(0),-(cos(A*( x-sin(A*x)*Th/sqrt(sin(A*x)*sin(A*x)+sin(A*y)*sin(A*y)+sin(A*z)*sin(A*z))))+cos(A*( y-sin(A*y)*Th/sqrt(sin(A*x)*sin(A*x)+sin(A*y)*sin(A*y)+sin(A*z)*sin(A*z))))+cos(A*( z-sin(A*z)*Th/sqrt(sin(A*x)*sin(A*x)+sin(A*y)*sin(A*y)+sin(A*z)*sin(A*z))))),1)"],
    ...
    {
      "Iso3D": {
        "Description": ["Animated Bone Cage model by Abderrahman Taha 08/10/2019"],
        ...
        },
    {
        "Param3D": {
            ...
            "Const": ["c=1/10000",
                ...
                "p2=1",
                "p3=2"],
            "Funct": ["Thickness=Th*cos(((4*M*(v-vmin)/(vmax-vmin)+1/2)%M)*(pi/2))",
