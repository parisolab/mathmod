{
	"MathModels": [{
		"Param3D": {
			"Description": ["Super Formula by Abderrahman Taha 06/03/2016"],
			"Name": ["Super Formula"],
			...
			"N22=1.7",
			"N32=1.7"],
			"Funct": ["Ru= (abs(cos(M1*u/4)*50/A1)^N21+abs(sin(M1*u/4)*50/B1)^N31)^(-1/N11)",
			"Rv= (abs(cos(M2*v/4)*50/A2)^N22+abs(sin(M2*v/4)*50/B2)^N32)^(-1/N12)"],
			"Fx": ["cos(u)*cos(v)*Ru(u,v,t)*Rv(u,v,t)"],
			"Fy": ["sin(u)*Ru(u,v,t)"],
			"Fz": ["cos(u)*sin(v)*Ru(u,v,t)*Rv(u,v,t)"],
			"Umax": ["pi/2"],
			"Umin": ["-pi/2"],
			"Vmax": ["2*pi"],
			"Vmin": ["0"]
