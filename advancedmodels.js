{
	"MathModels": [{
		"Iso3D": {
			...
			"DFx=(Scherk(x+0.01,y,z,t)-Scherk(x,y,z,t))/0.01",
			"DFy=(Scherk(x,y+0.01,z,t)-Scherk(x,y,z,t))/0.01",
			"DFz=(Scherk(x,y,z+0.01,t)-Scherk(x,y,z,t))/0.01",
			...
			"ScherkTorus=if(sqrt(x*x+y*y)<3.2, TickScherk(x,y,z,t),1)",
	...
	},
	{
		"Iso3D": {
			...
			"R00=0DOTSYMBOL1",
			"R01=0DOTSYMBOL24"],
			"Funct": ["Octahedra=(abs(x)+abs(y)+abs(z))-3DOTSYMBOL8*R00",
