{
	...
	},
	{
		"Param3D": {
			...
			"cv=0DOTSYMBOL001",
			"N=3"],
			"Funct": ["Tickness= DOTSYMBOL4*(- 0DOTSYMBOL5*(abs(sin(15*u)*cos(15*v)))^9 + 0DOTSYMBOL35*((sin(2*N*u))))",
			"Fx=-cos(u+v)/(sqrt(2DOTSYMBOL)+cos(v-u))",
			"Fy=sin(v-u)/(sqrt(2)+cos(v-u))",
			"Fz=sin(u+v)/(sqrt(2DOTSYMBOL)+cos(v-u))",
			"DFxu=((Fx(u,v,t)-Fx(u+cu,v,t))/cu)",
	...
	},
	{
		"Param3D": {
			...
			"Const": ["cu=0DOTSYMBOL0001",
			"cv=0DOTSYMBOL0001"],
			"Funct": ["Thickness= DOTSYMBOL2*(abs(sin(14*u)*cos(14*v)))^9 + 0DOTSYMBOL4*((sin(8*u)))",
	...
	},
	{
		"Param3D": {
			...
			"cv=0DOTSYMBOL0000000001",
			"N=10"],
			"Funct": ["Thickness2=if(sin(N*u)>0, DOTSYMBOL5*t*((sin(N*u)))^(1/4), - 0DOTSYMBOL5*t*(-(sin(N*u)))^(1/4)) ",
	...
	},
	{
		"Param3D": {
			...
			"cv=0DOTSYMBOL0000000001",
			"N=10"],
			"Funct": ["Thickness2=if(sin(N*u)>0, DOTSYMBOL5*((sin(N*u)))^(1/4), - 0DOTSYMBOL5*(-(sin(N*u)))^(1/4)) ",
	...
	},
	{
		...
		"Texture": {
			...
			"G=if((x*x+y*y+z*z)>0DOTSYMBOL8, DOTSYMBOL8*(cos((x*x+y*y+z*z)/5)*sin((x*x+y*y+z*z)))*sin((x*x+y*y+z*z)/DOTSYMBOL3), DOTSYMBOL5*sin((x*x+y*y+z*z)*9))",
