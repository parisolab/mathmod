...
void OpenGlWidget::png() { LocalScene.png_ok *= -1; }

void OpenGlWidget::jpg() { LocalScene.jpg_ok *= -1; }

void OpenGlWidget::bmp() { LocalScene.bmp_ok *= -1; }

void OpenGlWidget::quality(int c) { LocalScene.quality_image = c; }

void OpenGlWidget::colorstype(int c) { LocalScene.colortype = c; }

void OpenGlWidget::colorstypeParIso(int c) {
  LocalScene.colortype = LocalScene.colortypeParam = c;
}

void OpenGlWidget::colorstypeParam(int c) { LocalScene.colortypeParam = c; }
...
void OpenGlWidget::boundingboxOk() { LocalScene.boundingbox *= -1; }
...
void InitFont() { makeRasterFont(); }

void OpenGlWidget::run() {}

bool OpenGlWidget::timeractif() { return (LocalScene.anim == 1); }
...
void OpenGlWidget::starttimer() { timer->start(latence); }
...
void OpenGlWidget::startRendering() { glt.start(); }
...
void OpenGlWidget::timerEvent(QTimerEvent *) { update(); }
...
QImage OpenGlWidget::Copyscreenshot() { return (grabFrameBuffer()); }
