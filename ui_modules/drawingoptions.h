...
public slots:
    ...
    void slot_XYZscrollBarValueChanged(int);
    ...
    void on_xyhorizontalScrollBarValueChanged(int);
    void on_xzcheckBox_clicked();
    void on_xzhorizontalScrollBarValueChanged(int);
    void on_yzcheckBox_clicked();
    void on_yzhorizontalScrollBarValueChanged(int);
    void on_xwcheckBox_clicked();
    void on_xwhorizontalScrollBarValueChanged(int);
    void on_ywcheckBox_clicked();
    void on_ywhorizontalScrollBarValueChanged(int);
    void on_zwcheckBox_clicked();
    void on_zwhorizontalScrollBarValueChanged(int);
    ...
    void on_TimeStepScrollBarValueChanged(int);
    ...
    void on_C1ScrollBarValueChanged(int);
    void on_C2ScrollBarValueChanged(int);
    void on_C3ScrollBarValueChanged(int);
    void on_C4ScrollBarValueChanged(int);
    void on_C5ScrollBarValueChanged(int);
    void on_PredefinedSets_activated(int);
    void on_C6ScrollBarValueChanged(int);
    void on_C7ScrollBarValueChanged(int);
    void on_C8ScrollBarValueChanged(int);
    void on_C9ScrollBarValueChanged(int);
    void on_C10ScrollBarValueChanged(int);
    void on_C11ScrollBarValueChanged(int);
    void on_C12ScrollBarValueChanged(int);
    void on_C13ScrollBarValueChanged(int);
    void on_C14ScrollBarValueChanged(int);
    void on_C15ScrollBarValueChanged(int);
    void on_C16ScrollBarValueChanged(int);
    void on_C17ScrollBarValueChanged(int);
    void on_C18ScrollBarValueChanged(int);
    void on_C19ScrollBarValueChanged(int);
    void on_C20ScrollBarValueChanged(int);
    void CScrollBarValueChanged(int, int);
    ...
    void on_ShininessScrollBarValueChanged(int);
    void on_ThreadNumberScrollBarValueChanged(int);
    void on_StopCalculationsButton_clicked();
    void on_stopButton_clicked();
    void on_lineScrollBarValueChanged(int);
    void on_coloneScrollBarValueChanged(int);
