...
// --------------------------
DrawingOptions::~DrawingOptions() { delete[] SliderArray; }
...
// --------------------------
void DrawingOptions::slot_checkBox_clicked() { MathmodRef->slot_uv_clicked(); }
...
// --------------------------
void DrawingOptions::on_actionInfos_triggered() { MathmodRef->iso_infos(); }

// --------------------------
void DrawingOptions::on_actionFill_triggered() { MathmodRef->fill(); }

// --------------------------
void DrawingOptions::on_actionSmooth_triggered() { MathmodRef->smoothline(); }
...
// --------------------------
void DrawingOptions::on_updateParam_clicked() { on_updateButton_clicked(); }
...
// --------------------------
void DrawingOptions::on_uv4D_clicked() { MathmodRef->slot_uv4D_clicked(); }

// --------------------------
void DrawingOptions::on_uv_clicked() { MathmodRef->slot_uv_clicked(); }
...
// --------------------------
void DrawingOptions::on_actionMesh_triggered() { MathmodRef->Mesh(); }
...
// --------------------------
void DrawingOptions::on_actionAbout_2_triggered() { ab.show(); }
...
// --------------------------
void DrawingOptions::on_actionScreenshot_triggered() { videoplay(); }

// --------------------------
void DrawingOptions::on_actionEditor_triggered() { editorwin(); }

// --------------------------
void DrawingOptions::on_actionColors_triggered() { colorsoptions(); }

// --------------------------
void DrawingOptions::on_actionSmooth_2_clicked() { MathmodRef->smoothline(); }

// --------------------------
void DrawingOptions::on_Infos_clicked() { MathmodRef->iso_infos(); }

// --------------------------
void DrawingOptions::on_Mesh_clicked() { MathmodRef->Mesh(); }

// --------------------------
void DrawingOptions::on_Norm_clicked() { MathmodRef->draw_norm_clicked(); }

// --------------------------
void DrawingOptions::on_Fill_clicked() { MathmodRef->fill(); }
...
// --------------------------
void DrawingOptions::on_Load_clicked() { LoadNewFileModels(true); }
...
// --------------------------
void DrawingOptions::on_updateParam_2_clicked() { on_updateButton_clicked(); }
...
// --------------------------
void DrawingOptions::on_C9toolButton_clicked() { CIndextoolButton_clicked(9); }

// --------------------------
void DrawingOptions::on_C8toolButton_clicked() { CIndextoolButton_clicked(8); }

// --------------------------
void DrawingOptions::on_C7toolButton_clicked() { CIndextoolButton_clicked(7); }

// --------------------------
void DrawingOptions::on_C6toolButton_clicked() { CIndextoolButton_clicked(6); }

// --------------------------
void DrawingOptions::on_C5toolButton_clicked() { CIndextoolButton_clicked(5); }

// --------------------------
void DrawingOptions::on_C4toolButton_clicked() { CIndextoolButton_clicked(4); }

// --------------------------
void DrawingOptions::on_C3toolButton_clicked() { CIndextoolButton_clicked(3); }

// --------------------------
void DrawingOptions::on_C2toolButton_clicked() { CIndextoolButton_clicked(2); }

// --------------------------
void DrawingOptions::on_C1toolButton_clicked() { CIndextoolButton_clicked(1); }
// --------------------------
...
void DrawingOptions::on_actionScripts_selection_triggered() { select.show(); }
