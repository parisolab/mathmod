...
QStringList jiso::text () const
{
    return Text;
}

void jiso::setText(const QStringList & txt)
{
    Text = txt;
}

QStringList jiso::comment() const
{
    return Comment;
}

void jiso::setComment(const QStringList &cmt)
{
    Comment = cmt;
}

QStringList jiso::varu() const
{
    return Varu;
}

void jiso::setVaru(const QStringList &var)
{
    Varu = var;
}

QStringList jiso::csts() const
{
    return Csts;
}

void jiso::setConst(const QStringList &cst)
{
    Csts = cst;
}

QStringList jiso::funct() const
{
    return Funct;
}

void jiso::setFunct(const QStringList &fct)
{
    Funct = fct;
}

QStringList jiso::grid() const
{
    return Grid;
}

void jiso::setGrid(const QStringList &grd)
{
    Grid = grd;
}

QStringList jiso::rgbt() const
{
    return RGBT;
}

void jiso::setRGBT(const QStringList &rgb)
{
    RGBT = rgb;
}

QStringList jiso::fxyz() const
{
    return Fxyz;
}

void jiso::setFxyz(const QStringList &fct)
{
    Fxyz = fct;
}

QStringList jiso::xmin() const
{
    return Xmin;
}

void jiso::setXmin(const QStringList &xmi)
{
    Xmin = xmi;
}

QStringList jiso::xmax() const
{
    return Xmax;
}

void jiso::setXmax(const QStringList &xma)
{
    Xmax = xma;
}

QStringList jiso::ymin() const
{
    return Ymin;
}

void jiso::setYmin(const QStringList &ymi)
{
    Ymin = ymi;
}

QStringList jiso::ymax() const
{
    return Ymax;
}

void jiso::setYmax(const QStringList &yma)
{
    Ymax = yma;
}

QStringList jiso::zmin() const
{
    return Zmin;
}

void jiso::setZmin(const QStringList &zmi)
{
    Zmin = zmi;
}

QStringList jiso::zmax() const
{
    return Zmax;
}

void jiso::setZmax(const QStringList &zma)
{
    Zmax = zma;
}

QStringList jiso::component() const
{
    return Component;
}

void jiso::setComponent(const QStringList &cmp)
{
    Component = cmp;
}
