...
struct ObjectProperties
{
    ...
    float frontcols[40]={0.9f, 0.5f, 0.1f, 1.0f, 0.3f, 0.8f, 0.5f, 1.0f, 0.2f, 0.5f, 0.6f, 1.0f, 0.1f, 0.3f, 0.9f, 1.0f, 0.96f, 0.71f, 0.3f, 1.0f,
    ...
    float gridcol[4]  ={0.1f, 0.3f, 0.1f, 0.08f};
