...
void Iso3D::ConstructIsoSurface()
{
    ...
    /*
        ...
        if(WichPointVerifyCond[IndexFirstPoint]*WichPointVerifyCond[IndexSeconPoint]*WichPointVerifyCond[IndexThirdPoint] !=0)
        {
        ...
        NbTriangleIsoSurface++;
        }/// End if(WichPointVerifyCond[IndexFirstPoint]...

        ///+++++++++++++++++ Second Case ++++++++++++++++++++++++++++++++++++++++++///
        /// All points don't verify the condition
        else if (WichPointVerifyCond[IndexFirstPoint] == 0 &&
                 WichPointVerifyCond[IndexSeconPoint] == 0 &&
                 WichPointVerifyCond[IndexThirdPoint] == 0)
        {
        ...
        if(WichPointVerifyCond[IndexFirstPoint] == 0) {
         if(WichPointVerifyCond[IndexSeconPoint] == 0){
          if(WichPointVerifyCond[IndexThirdPoint] != 0){
        ...
        } /// End of if(WichPointVerifyCond[IndexThirdPoint] != 0)...
        }/// End of if(WichPointVerifyCond[IndexSeconPoint] == 0)
        else {
        ...
        if(WichPointVerifyCond[IndexSeconPoint] == 0 && WichPointVerifyCond[IndexThirdPoint] == 0) {
        ...
        else if (WichPointVerifyCond[IndexSeconPoint] == 0 && WichPointVerifyCond[IndexThirdPoint] != 0) {
        /// Aprime :
