{
	"MathModels": [{
		"Param3D": {
			...
			"Fx": ["cos(v)+1.4*u*cos(6*v+5*sin(t+v))*cos(v)"],
			"Fy": ["sin(v)+1.4*u*cos(6*v+5*sin(t+v))*sin(v)"],
			"Fz": ["1.4*u*sin(6*v+5*sin(t+v))"],
			"Umax": ["0.4"],
			"Umin": ["-0.4"],
			"Vmax": ["2*pi"],
			"Vmin": ["0"]
	...
	},
	{
		"Iso3D": {
			...
			"P=8.5",
			"R=14.5"],
			"Funct": ["Diamond=sin(x)*sin(y)*sin(z)-sin(x)*cos(y)*cos(z)-.5*cos(x)*sin(y)*cos(z)",
			"isoTransform=if(x*x<4.84,-Diamond(x,y,z+8*t,t),1)+M*exp(x*x-2.56)",
			"isoTransform2=isoTransform((sqrt(x*x+z*z)-P),y,N1*atan2(z,x),t)"],
			"Fxyz": ["-isoTransform2((sqrt(x*x+y*y)-R),N2*atan2(y,x),z/1.5,t)"],
			"Xmax": ["25"],
			"Xmin": ["-25"],
			"Ymax": ["25"],
			"Ymin": ["-25"],
	...
	{
		"Iso3D": {
			"Description": ["Tori of Octahedra by Abderrahman Taha 05/05/2016"],
			"Name": ["Tori of Octahedra"],
			...
			"R00=0.1",
			"R01=0.24"],
			"Funct": ["Octahedra=(abs(x)+abs(y)+abs(z))-3.8*R00",
			"Octahedra1 = Octahedra(x,y,(abs(z)%Step1)-Step1/2,t)",
			"Octahedra2 = -Octahedra1((abs(x+2*t)%Step2)-Step2/2,y,z+2*t,t)",
			"Cylinder2 = Octahedra2(x, (sqrt(y*y+z*z)-P1),N1*atan2(y,z),t)",
	...
	},
	{
		"Iso3D": {
			...
			"isoTransform=if(isoCondition_0(x,y,z,t)<0,-Diamond(x,y+8*t,1.5*z+10*t,t),1)+M*exp(isoCondition_1(x,y,z,t))",
			"isoTransform2=isoTransform((sqrt(x*x+z*z)-P),y,N1*atan2(z,x),t)"],
			"Fxyz": ["-isoTransform2((sqrt(x*x+y*y)-R),N2*atan2(y,x),z/1.5,t)"],
			"Xmax": ["25"],
			"Xmin": ["-25"],
	...
	},
	{
		"Iso3D": {
			...
			"P=5",
			"R=15"],
			"Funct": ["P_Skeletal0=-y-z+0.51*(-x*y+y*z+z*x)+1.2",
			"P_Skeletal=sin(x)+P_Skeletal0(cos(x), cos(y), cos(z), t)",
			"isoTransform=if((x-pi)*(x-pi)<13.25,P_Skeletal(x,y-4*t,z-20*t,t),1)+M*exp((x-pi)*(x-pi)-9.86)",
			"isoTransform2=isoTransform((sqrt(x*x+z*z)-P),y,N1*atan2(z,x),t)",
	...
	},
	{
		"Iso3D": {
			...
			"isoTransform=if(x*x<10.24,SchwarzP(x,y-2*t,z-3*t,t),1)+0.1*M*exp(x*x-9)",
	...
	},
	{
		"Iso3D": {
			...
			"Name": ["Red giant"],
			"Component": ["Redgiant"],
			"Fxyz": ["-((x*x+y*y+z*z-1)+(if(t<pi/2, 1,5*  if(t<pi,  abs(sin(t-pi/2)), abs(sin(3*t-pi/2))) ))*(NoiseW(6*x,6*y,5*cos(t)+6*z,4,2,0)  +NoiseW(4*sin(t)+6*x,5*cos(t) + 6*y,6*z,4,0,0))/5)*( atan2(y,x)<(pi/2) | atan2(sqrt(x*x+y*y),z)>(pi/2)) *(x^2+y^2+z^2-.03)"],
			"Xmax": ["1"],
			"Xmin": ["-1"],
			"Ymax": ["1"],
			"Ymin": ["-1"],
